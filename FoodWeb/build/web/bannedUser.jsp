<%-- 
    Document   : bannedUser
    Created on : Jul 12, 2024, 10:29:40 AM
    Author     : htduy
--%>
        ...
        <div class="container">
            <div class="left-section">
                <div class="inner-content">
                    ...
                    <p class="subheading">Oh no you have been banned!!!</p>
                    <p class="subheading"><a href="MainController?action=register">Do you want to register new account?</a></p>                 
                </div>
            </div>
